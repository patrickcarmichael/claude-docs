---
title: "Welcome to Windsurf Plugins"
...
← Previous: [Supported IDEs and Versions](./supported-ides-and-versions.md) | [Index](./index.md) | Next: [Guide for Admins](./guide-for-admins.md) →