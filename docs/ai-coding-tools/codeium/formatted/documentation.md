---
title: "Codeium Complete Documentation"
description: "Complete reference for Codeium"
---

# Codeium Documentation

This is the complete formatted documentation for Codeium, parsed and organized from the official documentation.
