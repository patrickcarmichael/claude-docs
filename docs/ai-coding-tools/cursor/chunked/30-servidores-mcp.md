...
**Navigation:** [← Previous](./29-edição-inline.md) | [Index](./index.md) | [Next →](./31-корпоративные-настройки.md)

---

# Servidores MCP
Source: https://docs.cursor.com/pt-BR/tools/mcp

Explora e instala servidores MCP para o Cursor
...
Explore e instala servidores MCP para o Cursor
Devs podem [criar um botão Add to Cursor](/pt-BR/tools/developers#generate-install-link) e incluir o link na tua documentação de desenvolvedor para facilitar a instalação no Cursor
...
<div id="mcp-servers" className="grid gap-4 md:grid-cols-3">
  <Card>
    <div>
      ...
      <p className="m-0">Workspace tudo em um para notas, docs e gerenciamento de projetos.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Plataforma de design e colaboração para times.</p>
    </div>
    ...
    <McpInstallButton
      ...
      prompt={<>
Baixa a versão mais recente do <a href="https://www.figma.com/downloads/" target="_blank">app de desktop do Figma</a> para hospedar o servidor MCP do Figma. Dá uma olhada no <a href="https://help.figma.com/hc/en-us/articles/32132100833559-Guide-to-the-Dev-Mode-MCP-Server" target="_blank">guia de configuração oficial do Figma</a> para as instruções de instalação
</>}
    />
  </Card>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Rastreamento de issues e gestão de projetos para equipes de desenvolvimento.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Plataforma de controle de versão e desenvolvimento colaborativo.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Testes de navegador de ponta a ponta.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Rastreamento de erros e monitoramento de performance.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Banco de dados SQL OLAP in-process para análises locais.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Gerencia projetos e implantações na Vercel.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Plataforma DevSecOps para código, CI/CD e segurança.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Ferramentas de gestão de projetos e colaboração, incluindo o Jira e o Confluence.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Analytics, rastreamento de erros e flags de recursos.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">APIs para processamento de pagamentos.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">APIs de pagamentos.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">dbt CLI, camada semântica e Discovery API.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Sessões de navegador sem interface (headless) para agentes.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Cria e deploya projetos web.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Ferramentas para desenvolvimento de apps Shopify.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Varredura de vulnerabilidades no teu repositório de código.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Automatiza fluxos de trabalho entre aplicativos.</p>
    </div>

    <McpInstallButton full server={{"name":"Zapier","install":"https://help.zapier.com/hc/en-us/articles/36265392843917-Use-Zapier-MCP-with-your-client#h_01JT58SDFENNA3R8906YD3T820"}} prompt={"Cada servidor é exclusivo para o usuário conectado e requer configuração. Clica em 'Continue' para ir à página de configuração do Zapier e começar."} />
  </Card>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Gerencia apps e recursos na Heroku.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Acessa o Hugging Face Hub e os servidores MCP do Gradio.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Cria e administra sites no Wix.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Faz uma varredura no código em busca de vulnerabilidades de segurança.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Acessa dados de contas financeiras.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Acesse a documentação do Mercado Pago.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Feature flags como serviço.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Documentação de código sempre atualizada.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <div className="flex items-baseline gap-2">
        <h2 className="m-0 text-neutral-900 dark:text-white">Documentação da AWS</h2>

        <Icon icon="badge-check" iconType="solid" size={14} color="rgb(56, 100, 246)" />
      </div>

      <p className="m-0">
        Acessa a documentação da AWS, faz buscas e recebe recomendações.
      </p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Insights sobre riscos de segurança em código.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Faz consultas e gerencia o InstantDB.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">APIs de análise em tempo real.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Gerencia dados e implantações do MongoDB.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Gerencia o Neon Postgres.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Analisar o código com o SonarQube.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Analisa e protege dependências.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Catálogo de dados, linhagem e contexto.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Conecta a APIs e a fluxos de trabalho.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Gerencie recursos do Auth0.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Pesquisar nos docs da Microsoft.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Acessa a documentação do Mercado Livre.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Consulta dados de observabilidade e SLOs.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Gerenciar incidentes e alertas.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Cria e gerencia PRs em pilha.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Faz deploy de apps, bancos de dados e serviços.</p>
    </div>
  ...
  <Card>
    <div>
      ...
      <p className="m-0">Colaboração e teste de API.</p>
    </div>
...
<div className="text-left mb-16 mt-4 max-w-[52rem] mx-auto flex flex-col gap-3 px-4 items-start text-sm">
  <p className="text-neutral-600 dark:text-neutral-400">
    Este é um conjunto curado de ferramentas MCP para desenvolvedores, fornecidas por provedores oficiais.
    Se a tua empresa ou ferramenta oferece um servidor MCP oficial e tu quer que ele seja
    incluído, {" "}
    ...
    <a target="_blank" href="https://github.com/cursor/mcp-servers" className="text-black dark:text-white inline underline decoration-neutral-200 underline-offset-4 font-medium hover:decoration-neutral-400 transition-colors">
      abre um PR ou cria uma issue no GitHub
    </a>

    {" "}

    que a gente revisa pra incluir.
  </p>
</div>
...
# Problemas comuns
Source: https://docs.cursor.com/pt-BR/troubleshooting/common-issues

Soluções para problemas frequentes e FAQs

Abaixo estão problemas comuns e suas soluções.

<div id="networking-issues">
  ### Problemas de rede
</div>

Primeiro, confere tua conectividade de rede. Vai em `Cursor Settings` > `Network` e clica em `Run Diagnostics`. Isso testa tua conexão com os servidores do Cursor e ajuda a identificar eventuais problemas de rede que podem afetar os recursos de IA, atualizações ou outras funcionalidades online.

O Cursor depende de HTTP/2 para recursos de IA porque lida melhor com respostas em streaming. Se tua rede não suporta HTTP/2, tu pode ter falhas de indexação e problemas com recursos de IA.

Isso costuma acontecer em redes corporativas, VPNs ou ao usar proxies como o Zscaler.

Pra resolver, ativa o fallback para HTTP/1.1 nas configurações do app (não nas configurações do Cursor): pressiona `CMD/CTRL + ,`, busca por `HTTP/2` e habilita `Disable HTTP/2`. Isso força o uso de HTTP/1.1 e resolve o problema.

A gente planeja adicionar detecção e fallback automáticos.

<div id="resource-issues-cpu-ram-etc">
  ### Problemas de recursos (CPU, RAM etc.)
</div>

Uso alto de CPU ou RAM pode deixar tua máquina lenta ou disparar alertas de recursos.

Embora bases de código grandes exijam mais recursos, o consumo alto geralmente vem de extensões ou configurações.

<Note>
  Se tu estiver vendo um aviso de RAM baixa no **macOS**, fica ligado: há um bug para alguns usuários que pode mostrar valores totalmente incorretos. Se isso acontecer, abre o Monitor de Atividade e olha a aba "Memória" para ver o uso correto.
</Note>

Se tu estiver enfrentando uso alto de CPU ou RAM, tenta estes passos:

<AccordionGroup>
  <Accordion title="Verifica tuas extensões">
    Extensões podem impactar o desempenho.

    O Extension Monitor mostra o consumo de recursos de todas as tuas extensões instaladas e internas.

    Ativa o Extension Monitor em `Settings` > `Application` > `Experimental` e alterna `Extension Monitor: Enabled`. Isso vai te pedir pra reiniciar o Cursor.

    Abre assim: `Cmd/Ctrl + Shift + P` → `Developer: Open Extension Monitor`.

    O Cursor executa tuas extensões em um ou mais **extension hosts**. Normalmente, a maioria das tuas extensões roda no mesmo extension host, o que significa que uma extensão consumindo muito tempo de CPU pode sufocar as extensões vizinhas!

    O Extension Monitor vai mostrar:

    * Todo processo de longa duração iniciado por uma extensão (somente macOS e Linux).
    * **% Ext Host**: A porcentagem do tempo total do extension host consumida por essa extensão. Ajuda a identificar quais extensões estão usando mais tempo em relação às outras.
    * **Max Blocking**: O maior bloco contínuo de execução de uma extensão por intervalo de monitoramento.
    * **% CPU**:
      * Para extensões: A porcentagem do uso total de CPU atribuída ao código da extensão.
      * Para processos: A porcentagem do uso total de CPU atribuída ao processo iniciado (somente macOS e Linux).
    * **Memory**:
      * Para extensões: A quantidade de memória de heap JS usada pelo código da extensão (alocações externas não contam).
      * Para processos: A quantidade de memória do sistema usada pelo processo iniciado (somente macOS e Linux).

    Tu também pode testar executando `cursor --disable-extensions` no terminal. Se o desempenho melhorar, reativa as extensões uma a uma pra identificar as problemáticas.

    Experimenta o Extension Bisect pra identificar extensões problemáticas. Lê mais [aqui](https://code.visualstudio.com/blogs/2021/02/16/extension-bisect#_welcome-extension-bisect). Observação: funciona melhor para problemas imediatos, não degradação gradual de desempenho.
  </Accordion>

  <Accordion title="Usa o Process Explorer">
    O Process Explorer mostra quais processos consomem recursos.

    Abre assim: Command Palette (`Cmd/Ctrl + Shift + P`) → `Developer: Open Process Explorer`.

    Revisa processos em:

    * **`extensionHost`**: Problemas relacionados a extensões
    * **`ptyHost`**: Consumo de recursos do terminal

    O Process Explorer exibe cada terminal e seus comandos em execução para diagnóstico.

    Para outros processos com uso elevado, relata no [fórum](https://forum.cursor.com/).
  </Accordion>

  <Accordion title="Monitora os recursos do sistema">
    Usa as ferramentas de monitoramento do teu sistema operacional para descobrir se o problema é específico do Cursor ou do sistema como um todo.
  </Accordion>

  <Accordion title="Testando uma instalação mínima">
    Se os problemas persistirem, testa uma instalação mínima do Cursor.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Vejo uma atualização no changelog, mas o Cursor não atualiza">
    Novas versões usam rollouts em etapas — usuários selecionados aleatoriamente recebem as atualizações primeiro. Espera a tua atualização em alguns dias.
  </Accordion>

  <Accordion title="Tenho problemas com meu login do GitHub no Cursor / Como faço logout do GitHub no Cursor?">
    Usa `Sign Out of GitHub` na paleta de comandos `Ctrl/⌘ + Shift + P`.
  </Accordion>

  <Accordion title="Não consigo usar GitHub Codespaces">
    GitHub Codespaces ainda não é compatível.
  </Accordion>

  <Accordion title="Estou com erros ao conectar via Remote SSH">
    SSH para máquinas Mac ou Windows não é compatível. Para outros problemas, reporta no [fórum](https://forum.cursor.com/) com logs.
  </Accordion>

  <Accordion title="Problemas de conexão SSH no Windows">
    Se tu vês "SSH is only supported in Microsoft versions of VS Code":

    1. Desinstala o Remote-SSH:
       * Abre a visualização de Extensões (`Ctrl + Shift + X`)
       * Busca por "Remote-SSH"
       * Clica no ícone de engrenagem → "Uninstall"

    2. Instala o Anysphere Remote SSH:

    * Abre o marketplace do Cursor
    * Busca por "SSH"
    * Instala a extensão Anysphere Remote SSH

    3. Depois de instalar:

    * Fecha todas as instâncias do VS Code com conexões SSH ativas
    * Reinicia o Cursor
    * Reconecta via SSH

    Verifica se a tua configuração e tuas chaves SSH estão corretas.
  </Accordion>

  <Accordion title="Cursor Tab e Inline Edit não funcionam atrás do meu proxy corporativo">
    Cursor Tab e Inline Edit usam HTTP/2 para menor latência e uso de recursos. Alguns proxies corporativos (por exemplo, Zscaler) bloqueiam HTTP/2. Corrige definindo `"cursor.general.disableHttp2": true` nas configurações (`Cmd/Ctrl + ,`, busca por `http2`).
  </Accordion>

  <Accordion title="Acabei de assinar o Pro, mas ainda estou no plano gratuito no app">
    Faz logout e login de novo nas Configurações do Cursor.
  </Accordion>

  <Accordion title="Quando meu uso vai reiniciar?">
    Assinantes Pro: clica em `Manage Subscription` no [Dashboard](https://cursor.com/dashboard) para ver a tua data de renovação.

    Usuários do plano gratuito: confere a data do teu primeiro e-mail do Cursor. O uso reinicia mensalmente a partir dessa data.
  </Accordion>

  <Accordion title="Meu histórico do Chat/Composer sumiu após uma atualização">
    Pouco espaço em disco pode fazer o Cursor limpar dados históricos durante atualizações. Para evitar isso:

    1. Mantém espaço livre suficiente em disco antes de atualizar
    2. Limpa arquivos desnecessários do sistema regularmente
    3. Faz backup de conversas importantes antes de atualizar
  </Accordion>

  <Accordion title="Como desinstalo o Cursor?">
    Segue [este guia](https://code.visualstudio.com/docs/setup/uninstall). Substitui "VS Code" ou "Code" por "Cursor" e ".vscode" por ".cursor".
  </Accordion>

  <Accordion title="Como deleto minha conta?">
    Clica em `Delete Account` no [Dashboard](https://cursor.com/dashboard). Isso exclui permanentemente a tua conta e todos os dados associados.
  </Accordion>

  <Accordion title="Como abro o Cursor pela linha de comando?">
    Roda `cursor` no teu terminal. Se o comando não existir:

    1. Abre a paleta de comandos `⌘⇧P`
    2. Digita `install command`
    3. Seleciona `Install 'cursor' command` (opcionalmente instala o comando `code` para substituir o do VS Code)
  </Accordion>

  <Accordion title="Não consigo entrar no Cursor">
    Se ao clicar em Sign In tu és redirecionado para cursor.com mas não entra, desativa teu firewall ou antivírus — eles podem estar bloqueando o processo de login.
  </Accordion>

  <Accordion title="Mensagem de atividade suspeita">
    Devido ao aumento recente de uso indevido do nosso sistema, tua solicitação pode ter sido bloqueada como medida de segurança. Aqui vai como resolver:

    Primeiro, confere tua VPN. Se estiver usando uma, tenta desligar, porque VPNs às vezes podem acionar nossos sistemas de segurança.

    Se isso não resolver, tu podes tentar:

    * Criar um novo chat
    * Esperar um pouco e tentar de novo depois
    * Criar uma nova conta usando autenticação do Google ou GitHub
    * Fazer upgrade para o Cursor Pro
  </Accordion>
</AccordionGroup>



# Obtendo um Request ID
Source: https://docs.cursor.com/pt-BR/troubleshooting/request-reporting

Encontre IDs de requisição para suporte técnico

Quando a equipe do Cursor estiver investigando um problema técnico, a gente pode pedir um “request ID”.

<div id="what-is-a-request-id">
  ## O que é um request ID?
</div>

Um request ID identifica de forma única cada requisição ao Cursor nos nossos sistemas internos.

Exemplo de formato: `8f2a5b91-4d3e-47c6-9f12-5e8d94ca7d23`

<div id="how-do-i-find-a-request-id">
  ## Como encontro um request ID?
</div>

<Warning>
  Request IDs ficam limitados quando o Privacy Mode está ativado. Desativa o Privacy Mode ao relatar problemas.

  Observação: usuários do plano Business têm o Privacy Mode ativado por padrão pelo admin da organização.
</Warning>

<div id="getting-your-current-request-id">
  ### Pegando o request ID atual
</div>

Pra reportar um problema com tua conversa atual ou recente:

Com a conversa aberta na barra lateral do Chat, usa o menu de contexto (canto superior direito) e seleciona `Copy Request ID`.
...
Manda o request ID copiado pra gente pelo fórum ou e-mail, como solicitado.

<div id="getting-a-request-id-from-a-previous-action">
  ### Pegando um request ID de uma ação anterior
</div>

Recupera request IDs históricos usando o comando `Report AI Action`:

1. Abre o command palette `⌘⇧P`
2. Digita `Report AI Action`
3. Seleciona a opção `Report AI Action`

Isso mostra tuas ações recentes de IA no Chat, CMD+K e Apply.
...
Seleciona a ação conferindo o horário e a feature. Copia o request ID e manda pra gente.



# Troubleshooting Guide
Source: https://docs.cursor.com/pt-BR/troubleshooting/troubleshooting-guide

Steps to fix issues and report bugs

Problemas no Cursor podem vir de extensões, dados do app ou do sistema. Testa estas etapas de solução de problemas.

<CardGroup cols={1}>
  <Card horizontal title="Reporting an Issue" icon="bug" href="#reporting-an-issue">
    Etapas para relatar um problema para o time do Cursor
  </Card>
</CardGroup>
...
<Steps>
  <Step title="Verificar a conectividade de rede">
    Primeiro, confere se o Cursor consegue se conectar aos serviços.

    **Executa o diagnóstico de rede:** Vai em `Cursor Settings` > `Network` e clica em `Run Diagnostics`. Isso testa tua conexão com os servidores do Cursor e identifica problemas de rede que afetam recursos de IA, atualizações ou outras funcionalidades online.

    Se o diagnóstico indicar problemas de conectividade, confere as configurações do firewall, do proxy ou possíveis restrições de rede que possam estar bloqueando o acesso do Cursor.
  </Step>

  <Step title="Limpar dados das extensões">
    Para problemas com extensões:

    **Desativa todas as extensões temporariamente:** Roda `cursor --disable-extensions` no terminal. Se os problemas sumirem, reativa as extensões uma a uma pra identificar qual tá causando o problema.

    **Zera os dados da extensão:** Desinstala e reinstala as extensões problemáticas pra resetar os dados armazenados. Confere as configurações da extensão que podem persistir após a reinstalação.
  </Step>

  <Step title="Limpar dados do app">
    <Warning>
      Isso apaga teus dados do app, incluindo extensões, temas, snippets e dados relacionados à instalação. Exporta teu perfil antes pra preservar esses dados.
    </Warning>

    O Cursor armazena dados do app fora do app pra restaurar entre atualizações e reinstalações.

    Pra limpar os dados do app:

    **Windows:** Roda estes comandos no Prompt de Comando:
    ...
    **macOS:** Roda `sudo rm -rf ~/Library/Application\ Support/Cursor` e `rm -f ~/.cursor.json` no Terminal.

    **Linux:** Roda `rm -rf ~/.cursor ~/.config/Cursor/` no Terminal.
  </Step>

  <Step title="Desinstalar o Cursor">
    Pra desinstalar o Cursor:

    <CardGroup cols={1}>
      <Card horizontal title="Windows" icon="windows">
        Procura por "Add or Remove Programs" no Menu Iniciar, acha "Cursor" e clica em "Uninstall".
      </Card>

      <Card horizontal title="macOS" icon="apple">
        Abre a pasta Applications, clica com o botão direito em "Cursor" e seleciona "Move to Trash".
      </Card>

      <Card horizontal title="Linux" icon="linux">
        **Para pacotes .deb:** `sudo apt remove cursor`

        **Para pacotes .rpm:** `sudo dnf remove cursor` ou `sudo yum remove cursor`

        **Para AppImage:** Apaga o arquivo Cursor.appimage do local onde ele tá.
      </Card>
    </CardGroup>
  </Step>

  <Step title="Reinstalar o Cursor">
    Reinstala pela [página de downloads](https://www.cursor.com/downloads). Sem limpar os dados do app, o Cursor volta ao estado anterior. Caso contrário, tu recebe uma instalação limpa.
  </Step>
</Steps>
...
Se esses passos não ajudarem, reporta no [fórum](https://forum.cursor.com/).

<Card horizontal title="Fórum do Cursor" icon="message" href="https://forum.cursor.com/">
  Reporta um bug ou problema no fórum do Cursor
</Card>

Pra resolver rápido, envia:

<CardGroup cols={2}>
  <Card title="Captura de Tela do Problema" icon="image">
    Faz uma captura de tela e oculta informações sensíveis.
  </Card>

  <Card title="Passos para Reproduzir" icon="list-check">
    Documenta os passos exatos pra reproduzir o problema.
  </Card>

  <Card title="Informações do Sistema" icon="computer">
    Obtém as informações do sistema em:
  ...
  <Card title="Request IDs" icon="shield-halved" href="/pt-BR/troubleshooting/request-reporting">
    Clica pra ver nosso guia de como coletar Request IDs
  </Card>

  <Card title="Erros no Console" icon="bug">
    Confere o console do desenvolvedor: <br />
...
# Bem-vindo
Source: https://docs.cursor.com/pt-BR/welcome

Saiba mais sobre o Cursor e como começar

O Cursor é um editor de código com IA que entende teu repositório e te ajuda a programar mais rápido usando linguagem natural. É só descrever o que quer construir ou mudar que o Cursor gera o código pra você.
...
<CardGroup cols={3}>
  <Card title="Comece aqui" icon="rocket" href="/pt-BR/get-started/installation">
    <div>
      Baixa, instala e começa a construir com o Cursor em minutos
    </div>
  </Card>

  <Card title="Changelog" icon="sparkles" href="https://www.cursor.com/changelog">
    <div>
      Fica por dentro dos recursos e melhorias mais recentes
    </div>
  </Card>

  <Card title="CLI" icon="terminal" href="/pt-BR/cli/overview">
    <div>
      Usa o Cursor no teu terminal
    </div>
  </Card>

  <Card title="Conceitos" icon="lightbulb" href="/pt-BR/get-started/concepts">
    <div>
      Entende os conceitos e recursos centrais que impulsionam o Cursor
    </div>
  </Card>

  <Card title="Modelos" icon="brain" href="/pt-BR/models">
    <div>
      Explora os modelos de IA disponíveis e como escolher o ideal
    </div>
  </Card>

  <Card title="Guias" icon="book" href="/pt-BR/guides/working-with-context">
    <div>
      Aprende boas práticas e fluxos de trabalho pra diferentes casos de uso
    </div>
  </Card>

  <Card title="Downloads" icon="download" href="https://cursor.com/downloads" arrow>
    <div>
      Baixa o Cursor pro teu computador
    </div>
  </Card>

  <Card title="Fórum" icon="message" href="https://forum.cursor.com">
    <div>
      Pra dúvidas técnicas e pra compartilhar experiências, visita nosso fórum
    </div>
  </Card>

  <Card title="Suporte" icon="headset" href="mailto:hi@cursor.com">
    <div>
      Pra questões de conta e cobrança, manda um e-mail pro nosso time de suporte
    </div>
  </Card>
</CardGroup>
