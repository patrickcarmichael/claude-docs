**Navigation:** [← Previous](./50-delete-test.md) | [Index](./index.md) | [Next →](./52-list-test-invocations.md)
...
Reference: https://elevenlabs.io/docs/api-reference/tests/test-invocations/resubmit
