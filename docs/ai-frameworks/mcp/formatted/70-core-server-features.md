---
title: "Mcp: Core Server Features"
description: "Core Server Features section of Mcp documentation"
...
**Previous:** [← Understanding MCP servers](./69-understanding-mcp-servers.md)

**Next:** [Bringing Servers Together →](./71-bringing-servers-together.md)
