...
description: "Build an MCP server section of Mcp documentation"
...
**Previous:** [← Next steps](./40-next-steps.md)

**Next:** [What's happening under the hood →](./42-whats-happening-under-the-hood.md)
