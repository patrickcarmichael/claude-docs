...
**Previous:** [← NOTE: there are no edges between nodes A, B and C!](./72-note-there-are-no-edges-between-nodes-a-b-and-c.md)

**Next:** [Stream outputs →](./74-stream-outputs.md)
