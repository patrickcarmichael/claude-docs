---
title: "Langgraph: Stream from a workflow"
description: "Stream from a workflow section of Langgraph documentation"
...
**Previous:** [← Stream from an agent](./76-stream-from-an-agent.md)

**Next:** [Use the functional API →](./78-use-the-functional-api.md)
