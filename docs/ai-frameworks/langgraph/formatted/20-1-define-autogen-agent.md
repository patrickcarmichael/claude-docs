---
title: "Langgraph: 1. Define AutoGen agent"
description: "1. Define AutoGen agent section of Langgraph documentation"
...
**Previous:** [← Setup](./19-setup.md)

**Next:** [2. Create the graph →](./21-2-create-the-graph.md)
