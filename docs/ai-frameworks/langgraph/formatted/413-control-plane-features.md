---
title: "Langgraph: Control Plane Features"
description: "Control Plane Features section of Langgraph documentation"
...
**Previous:** [← Control Plane API](./412-control-plane-api.md)

**Next:** [Durable Execution →](./414-durable-execution.md)
