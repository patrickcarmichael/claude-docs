---
title: "Crewai: Define our flow state"
description: "Define our flow state section of Crewai documentation"
...
**Previous:** [← Define our models for structured data](./472-define-our-models-for-structured-data.md)

**Next:** [Step 6: Set Up Your Environment Variables →](./474-step-6-set-up-your-environment-variables.md)
